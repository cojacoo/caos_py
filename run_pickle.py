...
mcp.mcpick_out(mc,'mc_dump_test.pickle')
...
for i in np.arange(dummy.astype(int)):
    [particles,npart,thS,leftover,drained,t]=CAOSpy_run(i*int(output),(i+1)*int(output),dt,mc,pdyn,particles,leftover,drained)
