...
smooth=(4,4)                #smoothing window for thS calculations as no. of cells

#macropore 
macbf='macbase.dat'         #macropore definition file
macimg='mac_im.dat'             #macropore image list file
nomac=True                       #switch of macropores

#bromid tracer data
tracerbf='brprofileXI.dat'       #tracer base file
tracer_t_ex=3600.0          #time to excavation   
...
matrixdeffi='matrixdef_ref.dat' #matrix definition file
