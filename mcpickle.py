...
def mcpick_in(mc,fname):
	...
	mc_tracer_CI_pickle=pickle.dumps(mc.tracer_CI)
	mc_tracer_SD_Br_pickle=pickle.dumps(mc.tracer_SD_Br)
	mc_tracer_SD_CI_pickle=pickle.dumps(mc.tracer_SD_CI)
	mc_tracer_appl_Br_pickle=pickle.dumps(mc.tracer_appl_Br)
	mc_tracer_c_br_pickle=pickle.dumps(mc.tracer_c_br)
	mc_tracer_horgrid_pickle=pickle.dumps(mc.tracer_horgrid)
	mc_tracer_intensity_pickle=pickle.dumps(mc.tracer_intensity)
	mc_tracer_site_pickle=pickle.dumps(mc.tracer_site)
	mc_tracer_t_ex_pickle=pickle.dumps(mc.tracer_t_ex)
	mc_tracer_time_pickle=pickle.dumps(mc.tracer_time)
...
def mcpick_out(mc,fname):
	...
	[mc_D_pickle,mc_FC_pickle,mc_a_velocity_pickle,mc_a_velocity_real_pickle,mc_cH2O_pickle,mc_grid_sizefac_pickle,mc_inimf_pickle,mc_ku_pickle,mc_macP_pickle,mc_macbf_pickle,mc_maccells_pickle,mc_maccols_pickle,mc_macconnect_pickle,mc_macid_pickle,mc_macscalefac_pickle,mc_macshare_pickle,mc_matrixbf_pickle,mc_matrixdef_pickle,mc_matrixdeffi_pickle,mc_md_area_pickle,mc_md_contact_pickle,mc_md_depth_pickle,mc_md_pos_pickle,mc_md_share_pickle,mc_md_macdepth_pickle,mc_mgrid_pickle,mc_mxdepth_cr_pickle,mc_onepartpercell_pickle,mc_outdir_pickle,mc_p_cH2O_pickle,mc_p_ku_pickle,mc_p_th_pickle,mc_part_sizefac_pickle,mc_precf_pickle,mc_psi_pickle,mc_refarea_pickle,mc_smooth_pickle,mc_soildepth_pickle,mc_soilgrid_pickle,mc_soilmatrix_pickle,mc_stain_res_pickle,mc_subsfac_pickle,mc_t_cdf_fast_pickle,mc_t_cdf_slow_pickle,mc_t_dini_pickle,mc_t_dmn_pickle,mc_t_dmx_pickle,mc_t_end_pickle,mc_theta_pickle,mc_tracer_CI_pickle,mc_tracer_SD_Br_pickle,mc_tracer_SD_CI_pickle,mc_tracer_appl_Br_pickle,mc_tracer_c_br_pickle,mc_tracer_horgrid_pickle,mc_tracer_intensity_pickle,mc_tracer_site_pickle,mc_tracer_t_ex_pickle,mc_tracer_time_pickle,mc_tracer_vertgrid_pickle,mc_tracerbf_pickle,mc_wd_pickle,mc_zgrid_pickle]=pickle.loads(mc_pickle_l)
	...
	mc.tracer_CI=pickle.loads(mc_tracer_CI_pickle)
	mc.tracer_SD_Br=pickle.loads(mc_tracer_SD_Br_pickle)
	mc.tracer_SD_CI=pickle.loads(mc_tracer_SD_CI_pickle)
	mc.tracer_appl_Br=pickle.loads(mc_tracer_appl_Br_pickle)
	mc.tracer_c_br=pickle.loads(mc_tracer_c_br_pickle)
	mc.tracer_horgrid=pickle.loads(mc_tracer_horgrid_pickle)
	mc.tracer_intensity=pickle.loads(mc_tracer_intensity_pickle)
	mc.tracer_site=pickle.loads(mc_tracer_site_pickle)
	mc.tracer_t_ex=pickle.loads(mc_tracer_t_ex_pickle)
	mc.tracer_time=pickle.loads(mc_tracer_time_pickle)
